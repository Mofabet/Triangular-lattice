...
class Dashboard:
    ...
    def _build_widgets(self) -> None:
        ...
        self.r_color = RadioButtons(
            f.add_axes([0.855, 0.685, 0.125, 0.235], facecolor="0.97"),
            COLOR_MODES, active=COLOR_MODES.index(self.cfg.color_mode),
        )
        self.r_panel = RadioButtons(
            f.add_axes([0.855, 0.395, 0.125, 0.255], facecolor="0.97"),
        ...
        self.checks = CheckButtons(
            f.add_axes([0.855, 0.215, 0.125, 0.145], facecolor="0.97"),
        ...
        self.fig.text(0.855, 0.925, "colour by", fontsize=8, weight="bold")
        self.fig.text(0.855, 0.655, "analysis panel", fontsize=8, weight="bold")
        self.fig.text(0.855, 0.365, "overlays", fontsize=8, weight="bold")
    ...
    def _on_color(self, label) -> None:
        ...
        self.cbar.ax.set_title(cl, fontsize=8, pad=7)
